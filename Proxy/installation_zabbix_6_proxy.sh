...
# description
# installation Zabbix Proxy 6.0 LTS for : Debian, Ubuntu
# compatible versions : from Debian 9 to 11, from Ubuntu 14.04 to 20.04
...
#	Import initial schema and data
	zcat /usr/share/zabbix-sql-scripts/mysql/server.sql.gz | mysql --default-character-set=utf8mb4 -uzabbix -p$user_password zabbix
