...
""")
parser.add_argument(
    'hostgroup', help='List of hostgroups to delete', nargs='+')
parser.add_argument('-N', '--non-empty',
                    help='Also delete non-empty groups', action='store_true')
...
search = zapi.hostgroup.get(selectHosts='count', filter={
                            'name': args.hostgroup})
if search:
    for group in search:
