...
$ZabbixAgentVersion = "zabbix_agent-6.0.9-windows-amd64-openssl"
...
Invoke-WebRequest https://cdn.zabbix.com/zabbix/binaries/stable/6.0/6.0.9/$ZabbixAgentVersion.zip -OutFile "$DirectoryPath\$ZabbixAgentVersion.zip"
...
#	Set the IP address for Server/ServerActive ; Define HostMetadataItem ; Set up dynamically "Hostname"
#	Note :  backquote for new line
Get-Content "$DirectoryPath\conf\zabbix_agentd.conf" | %{$_ `
